...
public class ApiImageTask implements Runnable
{
    ...
    public ApiImageTask(final String modId, final int dimension, final Feature.MapType mapType, final ChunkPos startChunk, final ChunkPos endChunk, final Integer vSlice, final int zoom, final boolean showGrid, final Consumer<BufferedImage> callback) {
        this.modId = modId;
